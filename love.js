// مرورگرها پخش خودکار صدا رو تا قبل از اولین تعامل کاربر (کلیک/لمس) مسدود می‌کنن.
// اول تلاش می‌کنیم موزیک خودش پخش بشه؛ اگه مرورگر جلوش رو گرفت،
// با اولین کلیک/لمس/دکمه روی صفحه پخشش می‌کنیم.
    ...
    function startAudio() {
        ...
        if (playPromise !== undefined) {
            playPromise.catch(function () {
                // پخش خودکار مسدود شد؛ منتظر تعامل کاربر می‌مونیم.
            });
        }
    }
